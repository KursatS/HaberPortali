...
namespace HaberPortali_H5190062
{
    ...
    public partial class DbHaberPortaliEntities : DbContext
    {
        public DbHaberPortaliEntities()
            : base("name=DbHaberPortaliEntities")
        {
        }
        ...
        public virtual DbSet<tbl_AltYorum> tbl_AltYorum { get; set; }
        ...
        public virtual DbSet<tbl_Okunma> tbl_Okunma { get; set; }
